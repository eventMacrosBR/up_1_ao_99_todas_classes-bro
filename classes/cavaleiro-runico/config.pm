...
sub configurarBuild {
    my %configsBuild = (
        ...
        skillsClasse2T => 'Montaria 1, Perícia em Montaria 5, Perícia com Lança 5, Perfurar 5, Estocada 5, Perfurar em Espiral 5, Rapidez com Duas Mãos 10, Aparar Golpe 10, Contra-Ataque 5, Impacto de Tyr 4, Frenesi 1, Relaxar 1, Dedicação 5',
        skillsClasse3 => '',
