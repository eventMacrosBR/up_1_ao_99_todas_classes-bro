sub initParamsQuestClasse2{
	Commands::run("do iconf 510 7 1 0" ) #ervaAzul
	Commands::run("do iconf 957 10 1 0") #unhaApodrecida
	Commands::run("do iconf 932 10 1 0") #osso
	Commands::run("do iconf 958 10 1 0") #mandibula
}
